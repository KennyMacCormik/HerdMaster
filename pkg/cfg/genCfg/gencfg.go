...
// - Host: The IP address or hostname of the gRPC server. Validates as IPv4 or hostname (RFC1123).
// - Port: The port number for the gRPC server. Validates as a numeric value between 1025 and 65 535 (exclusive).
type GrpcConfig struct {
	Host string `mapstructure:"grpc_host" validate:"ip4_addr|hostname_rfc1123"` // GRPC_HOST. Default text
	Port string `mapstructure:"grpc_port" validate:"numeric,gt=1024,lt=65536"`  // GRPC_PORT. Default info
}
